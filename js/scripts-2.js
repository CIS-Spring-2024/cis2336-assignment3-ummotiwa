(function ($) {
	...
	var $menu = $("nav#menu").mmenu({
		...
		navbars: [{ position: 'bottom', content: ['<a href="#">© 2024 NourishNook Cafe</a>'] }]
	},
		{
			// configuration
			clone: true,
	...
	$('#openImage1').magnificPopup({
		items: {
			src: '../Images folder/depth-7-frame-0-5@2x.png',
			title: 'Muffin'
		},
		type: 'image',
	...
	$('#openImage2').magnificPopup({
		items: {
			src: '../Images folder/depth-7-frame-0-8@2x.png',
			title: 'Ouameal'
		},
		type: 'image',
		fixedContentPos: false,
	...
	$('#openImage3').magnificPopup({
		items: {
			src: '../Images folder/depth-7-frame-0@2x.png',
			title: 'Tuna Fries'
		},
		type: 'image',
		fixedContentPos: false,
	...
	$('#openGallery1').magnificPopup({
		items: [
			{
				src: '../Images folder/Muffin.jpg',
				title: 'Muufin'
			},
			{
				src: '../Images folder/Oatmeal.jpg',
				title: 'Ouameal'
			},
			{
				src: '../Images folder/Tuna Salad.jpg',
				title: 'Tuna Fries'
			}
		],
		gallery: {
